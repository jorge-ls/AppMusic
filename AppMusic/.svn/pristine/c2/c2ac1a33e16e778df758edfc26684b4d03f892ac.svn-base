...
public class PanelMasEscuchadas extends JPanel {
	...
	class MiTableModel extends AbstractTableModel {
		 private String[] columnNames = {"Titulo", "Interprete","NumReproducciones"};
		 ...
		 public Object getValueAt(int row, int col) {
			 if (col == 0)
				 ...
				 return data.get(row).getNumReproduccion();
		 }
	...
	public PanelMasEscuchadas(VentanaPrincipal v) {
		...
		gbl_panel.rowHeights = new int[]{20, 0, 10, 40, 0, 0, 15, 0};
		...
		table = new JTable(new MiTableModel(ControladorAppMusic.getUnicaInstancia().getMasEscuchadas(10)));
